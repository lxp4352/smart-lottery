...
/**
 * Description: 抽象活动领取模板类
 * <br/>
 * AbstractActivityPartakeBase
 *
 * @author laiql
 * @date 2021/12/6 14:09
 */
public abstract class AbstractActivityPartakeBase extends ActivityPartakeSupport implements IActivityPartake {
    ...
    public PartakeResult doPartake(PartakeReq req) {
        ...
        UserTakeActivityVO userTakeActivityVO = this.queryNoConsumedTakeActivityOrder(req.getActivityId(), req.getUserId());
